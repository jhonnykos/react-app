...
import {Breadcrumb, BreadcrumbItem, Input, Label, Col, Button, Row} from "reactstrap";
...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        // event.preventDefault(); //предотвращение дефолного поведения (перехода на др страницу)
    }
